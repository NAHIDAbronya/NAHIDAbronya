setTimeout(function() {
    m3D.init(
        [   
            ...
            { src: '3.jpg' },
            { src: '4.jpg' },
            { src: '', url: '../../index.html', title: '已经没啦，戳我返回', color: 'yellow'},
        ]
    );
}, 500);
...
var m3D = function () {
    ...
    var diapo = [],
        ...
        urlInfo,
        imagesPath = "resource/",
        camera = {x:0, y:0, z:-650, s:0, fov: 500},//相机初始位置和视野范围
        nw = 0,
        nh = 0;
    /* ==== camera tween methods 动画==== */
